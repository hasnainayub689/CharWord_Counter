        ...
        <div className="container">
            ...
            <div className="accordion" id="accordionExample">
                ...
                <div className="accordion-item">
                    ...
                    >
                        <div className="accordion-body" style={myStyle}>
                            TextUtils is a handy tool offering free character
                            counting services, delivering instant statistics on
                            both word count and character count for any given
                            text. This makes it ideal for composing text within
                            specified word or character limits.
                        </div>
                    </div>
                </div>
                <div className="accordion-item">
